 ...
 * on 2015-02-25 at 16:14:30 UTC 
 * Modify at your own risk.
 */

package com.cloudendpointstest.noteendpoint;
...
public class Noteendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetNote extends NoteendpointRequest<com.cloudendpointstest.noteendpoint.model.Note> {
    ...
    protected GetNote(java.lang.String id) {
      super(Noteendpoint.this, "GET", REST_PATH, null, com.cloudendpointstest.noteendpoint.model.Note.class);
   ...
   *
   * @param content the {@link com.cloudendpointstest.noteendpoint.model.Note}
   * @return the request
   */
  public InsertNote insertNote(com.cloudendpointstest.noteendpoint.model.Note content) throws java.io.IOException {
    InsertNote result = new InsertNote(content);
    initialize(result);
    return result;
  }

  public class InsertNote extends NoteendpointRequest<com.cloudendpointstest.noteendpoint.model.Note> {
     ...
     * @since 1.13
     */
    protected InsertNote(com.cloudendpointstest.noteendpoint.model.Note content) {
      super(Noteendpoint.this, "POST", REST_PATH, content, com.cloudendpointstest.noteendpoint.model.Note.class);
    }
  ...
  public class ListNote extends NoteendpointRequest<com.cloudendpointstest.noteendpoint.model.CollectionResponseNote> {
     ...
     */
    protected ListNote() {
      super(Noteendpoint.this, "GET", REST_PATH, null, com.cloudendpointstest.noteendpoint.model.CollectionResponseNote.class);
    }
   ...
   * @return the request
   */
  public UpdateNote updateNote(com.cloudendpointstest.noteendpoint.model.Note content) throws java.io.IOException {
    UpdateNote result = new UpdateNote(content);
    initialize(result);
    return result;
  }

  public class UpdateNote extends NoteendpointRequest<com.cloudendpointstest.noteendpoint.model.Note> {
     ...
     * @since 1.13
     */
    protected UpdateNote(com.cloudendpointstest.noteendpoint.model.Note content) {
      super(Noteendpoint.this, "PUT", REST_PATH, content, com.cloudendpointstest.noteendpoint.model.Note.class);
    }
